...
- (void)main
{
    ...
    @try {
        if ([self isCancelled] == NO && self.request.pixelsHigh > 0) {        
            ...
            vectors = (N3VectorArray)malloc(sizeof(N3Vector) * pixelsWide);
            fillVectors = (N3VectorArray)malloc(sizeof(N3Vector) * pixelsWide);
            fillNormals = (N3VectorArray)malloc(sizeof(N3Vector) * pixelsWide);
            tangents = (N3VectorArray)malloc(sizeof(N3Vector) * pixelsWide);
            normals = (N3VectorArray)malloc(sizeof(N3Vector) * pixelsWide);
            inSlabNormals = (N3VectorArray)malloc(sizeof(N3Vector) * pixelsWide);
