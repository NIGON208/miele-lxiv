...
- (void) computeCrossReferenceLinesBetween: (MPRDCMView*) mp1
                                   andView: (MPRDCMView*) mp2
                                    result: (float[2][3]) s
{
...
//		Point3D *viewUp = cam.viewUp;
	...
	[self computeCrossReferenceLinesBetween: mprView1 andView: mprView2 result: a];
	[self computeCrossReferenceLinesBetween: mprView1 andView: mprView3 result: b];
	[mprView1 setCrossReferenceLines: a andLine: b];
	
	[self computeCrossReferenceLinesBetween: mprView2 andView: mprView1 result: a];
	[self computeCrossReferenceLinesBetween: mprView2 andView: mprView3 result: b];
	[mprView2 setCrossReferenceLines: a andLine: b];
	
	[self computeCrossReferenceLinesBetween: mprView3 andView: mprView1 result: a];
	[self computeCrossReferenceLinesBetween: mprView3 andView: mprView2 result: b];
	[mprView3 setCrossReferenceLines: a andLine: b];
