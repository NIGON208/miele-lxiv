...
extern OFCondition mainStoreSCP(T_ASC_Association *assoc,
        ...
        DcmDataset **rspIds)
{
	...
	DcmQueryRetrieveDatabaseHandle *dbHandle = factory.createDBHandle(assoc->params->DULparams.calledAPTitle,
